    ...
    rows.forEach(function(row){
        content += `
            <tr>
                ...
                <td>
                    <a href="#" onclick="modalUpdate(${row.id_categoria})" class="pink-text tooltipped " data-tooltip="Modificar"><i class="material-icons pink-text text-darken-2">mode_edit</i></a>
                    <a href="#" onclick="confirmDelete(${row.id_categoria}, '${row.imagen_categoria}')" class="black-text tooltipped" data-tooltip="Eliminar"><i class="material-icons">delete</i></a>
                </td>
            </tr>
        `;
    });
