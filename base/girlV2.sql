...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-08-2019 a las 09:19:18
...
CREATE TABLE `roles` (
  ...
  `Nombre_Role` varchar(100) COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `roles` (`IdRole`, `Nombre_Role`, `Fecha_Creacion`, `Activo`) VALUES
(1, 'Admin', '2019-08-27 00:00:00', 1),
(2, 'Gerente', '2019-08-27 00:00:00', 1);
...
INSERT INTO `usuarios` (`id_usuario`, `nombres_usuario`, `apellidos_usuario`, `correo_usuario`, `alias_usuario`, `clave_usuario`, `FechaCreacion`, `FechaVencimiento`, `IdRole`) VALUES
(1, 'Pamela', 'Trejo', 'panayelyaguilar@gmail.com', 'Pam', '$2y$10$VI23L7lPxAaCp3KEZINNj.QtlOmL9F5573ymmGb2qWdV0UFnmvape', '2019-08-01 00:00:00', '2019-08-28 00:00:00', 1),
(2, 'Fernanda', 'Avendaño', 'fer.avendano@gmail.com', 'Fer', '$2y$10$vtxzSyUgTsmsVEe6k8wdgeG2D212zMn4NWh3KsMmiNYeHyjkLsPWm', NULL, NULL, 2);
...
--
-- Estructura de tabla para la tabla `vistaroles`
--

CREATE TABLE `vistaroles` (
  `IdVistaRole` int(11) NOT NULL,
...
CREATE TABLE `vistas` (
  `IdVista` int(11) NOT NULL,
  `Nombre_Vista` varchar(300) COLLATE latin1_spanish_ci NOT NULL,
  `Fecha_Creacion` datetime NOT NULL,
...
--
-- Indices de la tabla `vistaroles`
--
ALTER TABLE `vistaroles`
  ADD PRIMARY KEY (`IdVistaRole`);
...
--
-- AUTO_INCREMENT de la tabla `vistaroles`
--
ALTER TABLE `vistaroles`
  MODIFY `IdVistaRole` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_roles` FOREIGN KEY (`IdRole`) REFERENCES `roles` (`IdRole`) ON DELETE NO ACTION ON UPDATE CASCADE;
